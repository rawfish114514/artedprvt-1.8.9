...
abstract class BufferPanel extends JPanel{
...
class MainPanel extends BufferPanel{
...
class StatePanel extends BufferPanel{
...
class EntryPanel extends BufferPanel{
        ...
        KeyListener keyListener=(new KeyAdapter() {
            ...
            public List<String> useComplete(List<String> args){
                if(complete!=null) {
                    ...
                    complete.forEach(s->{if (sl.contains(lastArg)) {
                        c.add(s);
                    }});
                    if (cindex >= c.size()) {
                        cindex = 0;
...
abstract class Entry extends BufferPanel{
    public Entry(){
        setLayout(null);
    }
...
class ProcessEntry extends Entry{
...
class ProcessPopupMenu extends JPopupMenu{
    public Process process;
...
class ScriptsProcess extends ProcessAdapter{
...
class ClassifyEntry extends Entry{
